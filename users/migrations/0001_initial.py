    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('therapy_preferences', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ai_response_length', models.CharField(choices=[('short', 'Short'), ('medium', 'Medium'), ('long', 'Long')], default='medium', max_length=10)),
                ('conversation_style', models.CharField(choices=[('supportive', 'Supportive'), ('directive', 'Directive'), ('analytical', 'Analytical'), ('empathetic', 'Empathetic')], default='supportive', max_length=20)),
                ...
                ('reminder_frequency', models.CharField(choices=[('daily', 'Daily'), ('weekly', 'Weekly'), ('none', 'None')], default='none', max_length=10)),
